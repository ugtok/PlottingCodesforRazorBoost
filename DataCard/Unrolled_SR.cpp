...
void UnrolledPlots(){
  ...
  TString dir = " /Users/ufuktok/Downloads/Datacard/run_2022_03_14_syst/"; 
  ...
  TFile* file7 = TFile::Open(dir+"T5qqqqVV.root");
  TFile* file8 = TFile::Open(dir+"T2bW.root");
...
TH2D* htemp[8];
  ...
  for(int i=0;i<8;i++){ 
   ...
   for (int i=0; i<8;i++){         //  Hadronic SR
    ...
    htemp[6] = (TH2D*)file7->Get(Form("Signal/MRR2_S_signal_%s__1500_400", SigRegion[i].c_str()));
    htemp[7] = (TH2D*)file8->Get(Form("Signal/MRR2_S_signal_%s__800_500", SigRegion[i].c_str()));
...
////////////////////////////////////////////
  ...
  string MRR2Bins_1[64] = {"0-200", "200-300", "300-400", "400-500", "500-750", "750-850", "850-1000", "1000-3000", // SR_Had_1htop
                         "0-100", "100-150", "150-200", "200-300", "300-400", "400-500", "500-1000", "1000-3000",   // SR_Had_2htop
                         "0-200", "200-250", "250-300", "300-400", "400-500", "500-800", "800-1000", "1000-3000",   // SR_Had_V_b_45j
                         "0-200", "200-250", "250-300", "300-400", "400-500", "500-800", "800-1000", "1000-3000",   // SR_Had_V_b_6j
                         "0-200", "200-250", "250-300", "300-400", "400-500", "500-600", "600-1000", "1000-3000",   // SR_Had_1V_0b_34j
                         "0-200", "200-250", "250-300", "300-400", "400-500", "500-600", "600-1500", "1500-3000",   // SR_Had_1V_0b_5j
  ...
  string MRR2Bins_2[96] = {"0-200", "200-250", "250-350", "350-450", "450-500", "500-600", "600-800", "800-3000",   // SR_Had_H_b_45j
                          "0-200", "200-300", "300-350", "350-400", "400-500", "500-800", "800-1000","1000-3000",   // SR_Had_H_b_6j
                          "0-200", "200-250", "250-300", "300-350", "350-400", "400-450", "450-600", "600-3000",    // SR_Had_2H_b_6j
                          "0-200", "200-250", "250-350", "350-400", "400-500", "500-600", "600-850", "850-3000",    // SR_Had_HV_b_6j
                          "0-200", "200-300", "300-350", "350-450", "450-650", "650-850", "850-1000", "1000-3000",  // SR_Had_1H_0b_34j
                          "0-200", "200-300", "300-325", "325-350", "350-400", "400-600", "600-1000", "1000-3000",  // SR_Had_1H_0b_5j
                          ...
                          "0-200", "200-250", "250-300", "300-350", "350-400", "400-600", "600-1500", "1500-3000",  // SR_Had_HV_0b_5j
  ...
  string MRR2Bins_3[72] = {"0-200", "200-250", "250-300", "300-350", "350-400", "400-500", "500-600", "600-3000",   // SR_Lep_1htop
                          "0-150", "150-200", "200-250", "250-300", "300-350", "350-500", "500-600", "600-3000",    // SR_Lep_V_b
                          "0-150", "150-175", "175-200", "200-225", "225-250", "250-300", "300-800", "800-3000",    // SR_Lep_V_0b                      
                          "0-100", "100-150", "150-200", "200-250", "250-300", "300-400", "400-600", "600-3000",    // SR_Leptop_0htop
                          "0-200", "200-300", "300-400", "400-500", "500-600", "600-800", "800-1000", "1000-3000",  // SR_Leptop_1htop
                          "0-200", "200-300", "300-600", "600-1000", "1000-1250", "1250-1500", "1500-2000", "2000-3000", // SR_Lepjet_0V_24j
                          "0-200", "200-300", "300-600", "600-1000", "1000-1500", "1500-1750", "1750-2000", "2000-3000", // SR_Lepjet_0V_5j
  ...
  string NM1 = "#scale[0.7]{#font[52]{Hadronic channels, benchmark: 1500-400}}";
  ...
  leg->AddEntry(histo_1[6], "T5qqqqVV", "l");
  leg->AddEntry(histo_1[7], "T2bW", "l");
  ...
  c1->SaveAs("MRR2_Hadronic_NewBin.png"); 
  c1->Close();
  ...
  string NM2 = "#scale[0.7]{#font[52]{Higgs channels Benchmark: 1500-400}}";
  ...
  leg_2->AddEntry(histo_2[6], "T5qqqqVV", "l");
  leg_2->AddEntry(histo_2[7], "T2bW", "l");
  ...
  c2->SaveAs("MRR2_HiggsSR_NewBin.png");
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  string NM3 = "#scale[0.7]{#font[52]{Leptonic channels Benchmark: 1500-400}}";
  ...
  leg_3->AddEntry(histo_2[6], "T5qqqqVV", "l");
  leg_3->AddEntry(histo_2[7], "T2bW", "l");
  ...
  c3->SaveAs("MRR2_Leptonic_NewBin.png"); 
